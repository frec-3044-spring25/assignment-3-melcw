...
I discussed how to fix certain code errors with Hailey Trittin for Question 4, such as how to read in the data correctly. For Question 7, I asked her about an error I was getting when trying to create the rolling average sets for the 5, 10, and 20 yearspans. I also discussed with her how to remove the first 20 rows of the dataset for question 10.
