...
I discussed how to fix certain code errors with Hailey Trittin for Question 4, such as how to read in the data correctly. For Question 6, I asked about how to convert the dataset to make it possible to create a plot wiht it. For Question 7, I asked her about an error I was getting when trying to create the rolling average sets for the 5, 10, and 20 yearspans. I also discussed with her how to remove the first 20 rows of the dataset for question 10. Additionally, when trying to render my document, I kept getting an error message telling me "trying to use CRAN without setting a mirror." I asked ChatGPT how to fix the error using the prompt "how to fix "trying to use CRAN without setting a mirror" error in R." It told me to try to set a repos when installing the zoo package, which I added.
